module.exports = async (client, member, message, author, guild, args) => {
...
let font = await jimp.loadFont(jimp.FONT_SANS_32_BLACK) //We declare a 32px font
  ...
  let welcome = await jimp.read('https://www.fullcompass.com/common/products/lgr/175383.jpg') //We load the base image
