//note that this takes a while to send the image to the channel
      ...
      https.get(url, function(res) {
        ...
        res.on("end", function() {
          ...
          parser.parseString(body, function(err, result) {
            var postCount = result.posts.$.count - 2;
            if (postCount > 100) {
              postCount = 100;
            }
            if (postCount > 0) {
              ...
              message.channel.send("Error, please try the command again or that tag wasn't found");
            }
