...
module.exports.run = async (bot, message, args) => {
  ...
  if(args[0] == "help"){
    message.reply("Usage: d.mute <user> <1s/m/h/d>");
    return;
  }
  ...
  let incidentschannel = message.guild.channels.find(`name`, "d-log");
  if(!incidentschannel) return message.reply("Please create a d-log channel first!");
